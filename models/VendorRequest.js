...
const VendorRequest = sequelize.define("vendor_request", {
  id: {
  ...
  supplierBank: Sequelize.DataTypes.BLOB('long'),
  verification: Sequelize.DataTypes.BLOB('long'),
  ...
  additional: Sequelize.DataTypes.BLOB('long'),
});
